...
class AbuseTest {
     ...
     * Создание файла и заполнение его содержимым: File source...
     * Создание файла куда будет выведен результат: File target...
     * Выполнение действия программы и чтение полученного результата из файла target: Abuse.drop...
     * Проверка результатов в конце: assertThat...
     */
    @Test
