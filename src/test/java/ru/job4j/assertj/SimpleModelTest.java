...
class SimpleModelTest {
    /**
     * Проверка генерации исключения, когда
    ...
    /**
     * проверка метода принимающего аргументы
     */
    @Test
    void  checkName() {
        SimpleModel sm = new SimpleModel();
    ...
    /**
     * проверка наличия текстового информационного сообщения,
     * сопровождающего исключение
     */
    @Test
    void  checkMessage() {
        SimpleModel sm = new SimpleModel();
    ...
    /**
     * проверка содержания текстового информационного сообщения,
